...
void HAL_OPAMP_MspInit(OPAMP_HandleTypeDef* opampHandle)
{
  ...
  /* USER CODE END OPAMP1_MspInit 0 */
    ...
    PA3     ------> OPAMP1_VINM
    */
    GPIO_InitStruct.Pin = OP1_VIP_Pin|OP1_VOUT_Pin|GPIO_PIN_3;
  ...
  /* USER CODE END OPAMP2_MspInit 0 */
    ...
    PA7     ------> OPAMP2_VINP
    */
    GPIO_InitStruct.Pin = OP2_VIM_Pin|OP2_VOUT_Pin|OP2_VIP_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
  ...
  /* USER CODE END OPAMP3_MspInit 0 */
    ...
    PB2     ------> OPAMP3_VINM
    */
    GPIO_InitStruct.Pin = OP3_VIP_Pin|OP3_VOUT_Pin|OP3_VIM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /* USER CODE END OPAMP4_MspInit 0 */
    ...
    PB13     ------> OPAMP4_VINP
    */
    GPIO_InitStruct.Pin = OP4_VIM_Pin|OP4_VOUT_Pin|OP4_VIP_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
...
void HAL_OPAMP_MspDeInit(OPAMP_HandleTypeDef* opampHandle)
{
  ...
  /* USER CODE END OPAMP1_MspDeInit 0 */
    ...
    PA3     ------> OPAMP1_VINM
    */
    HAL_GPIO_DeInit(GPIOA, OP1_VIP_Pin|OP1_VOUT_Pin|GPIO_PIN_3);
  ...
  /* USER CODE END OPAMP2_MspDeInit 0 */
    ...
    PA7     ------> OPAMP2_VINP
    */
    HAL_GPIO_DeInit(GPIOA, OP2_VIM_Pin|OP2_VOUT_Pin|OP2_VIP_Pin);
  ...
  /* USER CODE END OPAMP3_MspDeInit 0 */
    ...
    PB2     ------> OPAMP3_VINM
    */
    HAL_GPIO_DeInit(GPIOB, OP3_VIP_Pin|OP3_VOUT_Pin|OP3_VIM_Pin);
  ...
  /* USER CODE END OPAMP4_MspDeInit 0 */
    ...
    PB13     ------> OPAMP4_VINP
    */
    HAL_GPIO_DeInit(GPIOB, OP4_VIM_Pin|OP4_VOUT_Pin|OP4_VIP_Pin);
