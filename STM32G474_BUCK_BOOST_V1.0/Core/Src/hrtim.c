...
void MX_HRTIM1_Init(void)
{
  ...
  pCompareCfg.CompareValue = 28500; /* Period-1500: duty=5% safe startup (Set=TIMPER,Reset=CMP1) */
  if (HAL_HRTIM_WaveformCompareConfig(&hhrtim1, HRTIM_TIMERINDEX_TIMER_E, HRTIM_COMPAREUNIT_1, &pCompareCfg) != HAL_OK)
  {
    Error_Handler();
  }
  pCompareCfg.CompareValue = 3000; /* CMP3>CMP1: TE1 duty=(3000-1500)/30000=5% at startup */
  ...
  pOutputCfg.SetSource = HRTIM_OUTPUTSET_TIMPER; /* Set at period start, Reset at CMP1 */
  pOutputCfg.ResetSource = HRTIM_OUTPUTRESET_TIMCMP1; /* duty=(Period-CMP1)/Period */
  ...
  pCompareCfg.CompareValue = 29999; /* Period-1: TF1 stays LOW, Q3 OFF at startup */
