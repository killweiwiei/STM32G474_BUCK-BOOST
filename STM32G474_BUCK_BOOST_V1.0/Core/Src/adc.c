...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  */
    ...
    PA2     ------> ADC1_IN3
    */
    GPIO_InitStruct.Pin = OP1_VOUT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(OP1_VOUT_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    PA6     ------> ADC2_IN3
    */
    GPIO_InitStruct.Pin = OP2_VOUT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(OP2_VOUT_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    PB1     ------> ADC3_IN1
    */
    GPIO_InitStruct.Pin = OP3_VOUT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(OP3_VOUT_GPIO_Port, &GPIO_InitStruct);

    /* ADC3 DMA Init */
    /* ADC3 Init */
    hdma_adc3.Instance = DMA2_Channel3;
  ...
  */
    ...
    PB12     ------> ADC4_IN3
    */
    GPIO_InitStruct.Pin = OP4_VOUT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(OP4_VOUT_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    /* ADC5 DMA Init */
    /* ADC5 Init */
    hdma_adc5.Instance = DMA2_Channel5;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA2     ------> ADC1_IN3
    */
    HAL_GPIO_DeInit(OP1_VOUT_GPIO_Port, OP1_VOUT_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PA6     ------> ADC2_IN3
    */
    HAL_GPIO_DeInit(OP2_VOUT_GPIO_Port, OP2_VOUT_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PB1     ------> ADC3_IN1
    */
    HAL_GPIO_DeInit(OP3_VOUT_GPIO_Port, OP3_VOUT_Pin);
  ...
  /* USER CODE END ADC4_MspDeInit 0 */
    ...
    PB12     ------> ADC4_IN3
    */
    HAL_GPIO_DeInit(OP4_VOUT_GPIO_Port, OP4_VOUT_Pin);
